...
const CreateProductForm = () => {
  ...
  myHeaders.append(
    "Authorization",
    "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzE0MjcxNDA1LCJpYXQiOjE3MTIxMTE0MDUsImp0aSI6IjVlNTg4Zjc5ZWFkZDRiNjY5MGZhNjEzYzYwOThiZjgxIiwidXNlcl9pZCI6MX0.kJTQkDMsVyZ2eOU--sj9fQjLN6ZWaGBJIG_UNf_JlLA"
  );
  myHeaders.append(
    "Cookie",
